...
let student2 = new Student("Мария", "женский", 19);
let student3 = new Student("Лидия", "женский", 19);
let student4 = new Student("Вячеслав", "мужской", 20);
...
Student.prototype.getAverage = function () {
  ...
  /*вариант вычислений в одну строку:
  let averageValue =
    this.marks.reduce((acc, el) => acc + el) / this.marks.length;*/
